...
#############################################################
# Get base name (without .fastq and _trimmed)
BASENAME=$(basename "$FASTQ" _trimmed.fastq)


IN_DIR="/home/data/fus_sysbio_ek2020/EK_fg_pangenome/Nanopore_seq_trimmed/trimmed_fastq/trimmed/"
FILTERED_DIR="/home/data/fus_sysbio_ek2020/EK_fg_pangenome/Nanopore_seq_trimmed/trimmed_fastq/trimmed/size_filtered"
ASM_DIR="/home/data/fus_sysbio_ek2020/EK_fg_pangenome/Nanopore_assembly/Hifiasm_all/${BASENAME}/"

mkdir -p "$FILTERED_DIR" "$ASM_DIR"
...
# Filter >10kb
FILTERED="$FILTERED_DIR/over10_${BASENAME}.fastq"

seqkit seq -m 10000 "$FASTQ" > "$FILTERED"

# Run hifiasm
PREFIX="$ASM_DIR/over10.write_reads_Hifi.${BASENAME}.asm"

/home/data/fus_sysbio_ek2020/Tools/hifiasm/hifiasm --ont -o "$PREFIX" --write-ec -t30 -f0 "$FILTERED"
